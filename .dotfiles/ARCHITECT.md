...
Use the command `/run /home/auek/bin/note "the thing to note"` to append the text to the scratchpad. This ensures the command is executed through the shell interface. This is for capturing important information, ideas, or decisions that come up during our interactions.
